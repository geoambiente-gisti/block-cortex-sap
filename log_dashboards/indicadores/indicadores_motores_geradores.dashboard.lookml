---
- dashboard: indicadores_dos_motores_geradores
  title: INDICADORES DOS MOTORES GERADORES
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: HUhlfNldLIQnr9hzZJh16G
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: Total de Horas - Parada Não Programada
    ...
    filters:
      indices_acumulados.sistema: Motorgerador
  ...
  - title: Confiabilidade Mensal
    ...
    filters:
      indices_por_sistema.sistema: Motorgerador
  ...
  - title: Disponibilidade Local Instalação
    ...
    filters:
      indices_por_sistema.sistema: Motorgerador
    sorts: [indices_por_sistema.instalacao]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
