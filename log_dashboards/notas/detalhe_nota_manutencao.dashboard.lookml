---
- dashboard: observao_e_nota_de_operao_associada_manutencao
  ...
  - title: Nota de Manutenção
    ...
    fields: [nota_manutencao_zspmlistnote.n_nota_serial, nota_manutencao_zspmlistnote.qmdat_date,
      nota_manutencao_zspmlistnote.mzeit, nota_manutencao_zspmlistnote.tplnr, zpmtb_no_nm.num_log_no]
    limit: 500
    column_limit: 50
    ...
    defaults_version: 1
    listen:
      Nº Nota Manutenção: nota_manutencao_zspmlistnote.n_nota_serial
    row: 0
    col: 0
    width: 12
    height: 6
  - title: Nota Operação
    ...
    fields: [nota_operacao_zspmlistnote.n_nota_serial, nota_operacao_zspmlistnote.qmdat_date,
      nota_operacao_zspmlistnote.mzeit, nota_operacao_zspmlistnote.occur_type,
      nota_operacao_zspmlistnote.contactname, nota_operacao_zspmlistnote.tplnr]
  ...
  - title: Observações da Nota
    ...
    height: 7
  filters:
  - name: Nº Nota Manutenção
    title: Nº Nota Manutenção
    type: field_filter
    default_value: ''
